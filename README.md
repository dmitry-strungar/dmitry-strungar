...
Специалист с практическим опытом продуктовой и BI аналитики, работы с SQL, Python и BI-дашбордами.  
Рассматриваю позиции в области аналитики данных, где могу приносить ценность через анализ метрик, поиск точек роста и визуализацию данных для поддержки бизнес-решений.
